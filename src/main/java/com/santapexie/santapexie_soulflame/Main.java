    ...
    public void onInitializeClient() {
        ...
        ClientTickEvents.START_CLIENT_TICK.register((client) -> {
            if(client.world != null) {
                onFireEntityList.removeIf(entity -> !entity.isAlive());
                onFireEntityList.removeIf(entity -> !(entity instanceof PlayerEntity) && !entity.isOnFire());
                ...
                client.world.getEntities().forEach(entity -> {
                    ...
                    if (!(entity instanceof PlayerEntity) && onFireEntityList.contains(entity) && entity instanceof MobEntity && entity.isInLava()) {
                        onFireEntityList.remove(entity);
                    }
