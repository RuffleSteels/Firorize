...
public class ChangeFireHeightScreen extends Screen {
    ...
    @Override
    protected void init() {
        // The height preview here is GUI-space (self-contained matrices), not the in-world fire path, so
        // own inConfig=false (hardening against modals — e.g. the Ko-fi popup — forcing it true and
        // leaking it back to the world). See DonatePopupScreen.
        Main.inConfig = false;
