                                ...
                                for (int ii = 0; ii < 3; ii++) {
                                    ...
                                    if (order == 0) {
                                        ...
                                        if (Main.CONFIG_MANAGER.getCurrentBlockFireColors().getLeft().get(2).containsKey(entity.method_48926().getBiome(mutable).getKey().get().getValue().toString())) {
                                            ((RenderFireColorAccessor) entity).firorize$setRenderFireColor(list.get(2).get(String.valueOf(entity.method_48926().getBiome(mutable).getKey().get().getValue().toString())).clone());
                                            return;
                                        }
                                    }
                                }
